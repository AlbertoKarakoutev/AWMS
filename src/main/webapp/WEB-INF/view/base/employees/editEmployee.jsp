                ...
                <div class="p-4">
                    ...
                    <c:if test="${newEmployee==false}">
                        ...
                        <div class="form-group">
                            ...
                            <input value="${employee.getPayPerHour()}" type="number" step="0.1" name="payPerHour" class="form-control" id="payPerHourEmployee" aria-describedby="payPerHourEmployee" placeholder="Pay Per Hour">
