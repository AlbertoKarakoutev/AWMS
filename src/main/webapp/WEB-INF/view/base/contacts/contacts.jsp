								...
								<div class="visit-card col-md-4 card-body">
									<div class="border rounded p-4">
										<div class="d-flex align-items-center">
											...
											<p>
												<b>Name:</b> ${owner.getFirstName()} ${owner.getLastName()}
											</p>
										</div>
										<div class="d-flex align-items-center">
											<i class="fas fa-briefcase mr-1"></i>
											<p>
												<b>Work position:</b> ${owner.getRole()}
											</p>
										</div>
										<div class="d-flex align-items-center">
											<i class="fas fa-phone-alt mr-1"></i>
											<p>
												<b>Telephone number:</b> ${owner.getPhoneNumber()}
											</p>
										</div>
									</div>
								</div>
									...
									<div class="visit-card col-md-4 card-body">
										<div class="border rounded p-4">
											...
											<div class="d-flex align-items-center">
												<i class="fas fa-briefcase mr-1"></i>
												<p>
													<b>Work position:</b> ${manager.getRole()}
												</p>
											</div>
											<div class="d-flex align-items-center">
												<i class="fas fa-phone-alt mr-1"></i>
												<p>
													<b>Telephone number: </b> ${manager.getPhoneNumber()}
												</p>
											</div>
										</div>
									</div>
